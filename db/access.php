...
$capabilities = [
    // Permiso para acceder a la vista de descarga de certificados
    'local/reportesnavarra:downloadcertificates' => [
    ...
    // Permiso para acceder a la vista de asociar roles
    'local/reportesnavarra:assignroles' => [
        'riskbitmask' => RISK_PERSONAL,
        'captype' => 'write',
